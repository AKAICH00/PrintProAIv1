            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        res = new operations.CreateVariationUpscaleResponse({
    ...
    Variation.prototype.getVariationById = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetVariationByIdRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        url = utils.generateURL(baseURL, "/variations/{id}", req);
                        client = this.sdkConfiguration.securityClient || this.sdkConfiguration.defaultClient;
                    ...
                    case 1:
                        ...
                        res = new operations.GetVariationByIdResponse({
                            statusCode: httpRes.status,
                            contentType: contentType,
                            rawResponse: httpRes,
                        });
