            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        res = new operations.CreateModelResponse({
    ...
    Model.prototype.deleteModelById = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.DeleteModelByIdRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        url = utils.generateURL(baseURL, "/models/{id}", req);
                        client = this.sdkConfiguration.securityClient || this.sdkConfiguration.defaultClient;
                    ...
                    case 1:
                        ...
                        res = new operations.DeleteModelByIdResponse({
                            statusCode: httpRes.status,
                            contentType: contentType,
                            rawResponse: httpRes,
                        });
    ...
    Model.prototype.getModelById = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetModelByIdRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        url = utils.generateURL(baseURL, "/models/{id}", req);
                    ...
                    case 1:
                        ...
                        res = new operations.GetModelByIdResponse({
                            statusCode: httpRes.status,
                            contentType: contentType,
                            rawResponse: httpRes,
                        });
